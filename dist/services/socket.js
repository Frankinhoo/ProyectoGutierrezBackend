...
var _require = require('../controller/productos'),
  productosController = _require.productosController;
var _require2 = require('../controller/mensajes'),
  mensajesController = _require2.mensajesController;
var io;
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              ...
              socket.on('NuevoProducto', /*#__PURE__*/function () {
                  ...
                  return _regeneratorRuntime().wrap(function _callee$(_context) {
                    while (1) {
                      switch (_context.prev = _context.next) {
                        case 0:
                          _context.next = 2;
                          return productosController.save(data);
                        case 2:
                        case "end":
            ...
            case 4:
              ...
              socket.on('NuevoMensaje', /*#__PURE__*/function () {
                  ...
                  return _regeneratorRuntime().wrap(function _callee2$(_context2) {
                    while (1) {
                      switch (_context2.prev = _context2.next) {
                        case 0:
                          _context2.next = 2;
                          return mensajesController.save(data);
                        case 2:
                        case "end":
              ...
              _context3.next = 9;
              return mensajesController.getAll();
            case 9:
              dataMensajes = _context3.sent;
...
var getWsServer = function getWsServer() {
  return io;
};
module.exports = {
